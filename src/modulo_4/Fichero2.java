...
public class Fichero2 {
    ...
    public static void main(String[] args) {
        ...
        try{        
            ObjectOutputStream escribiendo_fichero=new ObjectOutputStream(new FileOutputStream("src/archivos/ejemplo.txt"));
            escribiendo_fichero.writeObject(personal);            
            escribiendo_fichero.close();            
            ObjectInputStream recuperando_fichero=new ObjectInputStream(new FileInputStream("src/archivos/ejemplo.txt"));
